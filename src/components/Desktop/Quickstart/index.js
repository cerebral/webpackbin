    ...
    return (
      <div className={styles.backdrop}>
        <div className={styles.modal}>
          ...
          <p>
            You can choose to start your bin with an entry point. With the entry point you get access to adding
            NPM packages bundled with Webpack. You can at any time change <b>loaders</b> and <b>NPM packages</b> in the
            BIN settings.
          </p>
          ...
          <div className={styles.continue} onClick={() => hideQuickstartClicked()}>
