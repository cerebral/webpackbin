  ...
  class Log extends React.Component {
    render() {
      return (
        <div
          className={
            this.props.showFullLog ? styles.wrapper : styles.halfWrapper
          }
        >
          <div className={styles.info}>
            Use console.log() in your code to log
          </div>
          ...
          >
            <i
              className={this.props.showFullLog ? icons.halfLog : icons.fullLog}
            />
          </div>
        </div>
      );
