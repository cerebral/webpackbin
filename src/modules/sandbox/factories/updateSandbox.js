    ...
    parallel([
      showTimedSandboxMessages([
        ...
        },
        {
          time: 15000,
          message:
            'Still waiting, you probably added a rather large set of packages...',
        },
        {
          time: 15000,
          message:
            'It can actually take over a minute to package up, please hold on some more...',
        },
        {
          time: 15000,
          message:
            'I will error out if this takes more than 2 minutes, though please keep holding, will normally be done very soon :)',
        },
      ]),
      updateSandbox,
      {
        ...
        error: [
          ...
          showSnackbar(
            'Sorry, something went wrong, please report or refresh',
            5000,
            'error'
          ),
        ],
