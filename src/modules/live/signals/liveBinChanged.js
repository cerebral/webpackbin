  ...
  whenLiveParticipant,
  {
    true: [
      equals(props`key`),
      {
        ...
        lastSavedDatetime: [set(state`app.showSandbox`, true), updateSandbox()],
        ...
        selectedFileIndex: set(
          state`app.currentBin.selectedFileIndex`,
          props`value`
        ),
        ...
        showNewFileInput: set(
          state`app.currentBin.showNewFileInput`,
          props`value`
        ),
        showConfiguration: set(
          state`app.currentBin.showConfiguration`,
          props`value`
        ),
        ...
        selectedLogPath: set(
          state`app.currentBin.selectedLogPath`,
          props`value`
        ),
        currentParticipantKey: set(
