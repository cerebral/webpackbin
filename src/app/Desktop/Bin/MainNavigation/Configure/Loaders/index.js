...
export default connect({
  currentLoader: state`bin.configure.currentLoader`,
  loaders: state`bin.currentBin.loaders`,
  loaderSelected: signal`bin.configure.loaderSelected`,
  loaderToggled: signal`bin.configure.loaderToggled`
},
  function Loaders ({
    currentLoader,
    loaders,
